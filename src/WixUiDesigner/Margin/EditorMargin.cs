...
namespace WixUiDesigner.Margin
{
    ...
    internal class EditorMargin : Canvas, IWpfTextViewMargin
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EditorMargin"/> class for a given <paramref name="textView"/>.
        /// </summary>
        ...
        public EditorMargin(IWpfTextView textView)
        {
            ...
            // Add a green colored label that says "Hello EditorMargin"
            var label = new Label
            {
                Background = new SolidColorBrush(Colors.LightGreen),
                Content = "Hello EditorMargin",
            };
        ...
        {
            return string.Equals(marginName, EditorMargin.MarginName, StringComparison.OrdinalIgnoreCase) ? this : null;
        }

        /// <summary>
        /// Disposes an instance of <see cref="EditorMargin"/> class.
        /// </summary>
        public void Dispose()
        {
            if (!this.isDisposed)
