...
namespace WixUiDesigner.Margin
{
    ...
    [ContentType("wxs")]                                       // Show this margin for all text-based types
    ...
    internal sealed class EditorMarginFactory : IWpfTextViewMarginProvider
    {
        ...
        public IWpfTextViewMargin CreateMargin(IWpfTextViewHost wpfTextViewHost, IWpfTextViewMargin marginContainer)
        {
            ...
            Debug.WriteLine(WixUiDesignerPackage.Options?.DebugContext);
            return new EditorMargin(wpfTextViewHost.TextView);
        }
